...
import { Twitter, Github, Linkedin, FileText, Bot } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4 md:col-span-2 lg:col-span-1">
            <Link to="/" className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-bold"> AI Chat Bot</span>
            </Link>
            <p className="text-gray-400 leading-relaxed max-w-sm">
              The simplest way to chat and learn.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 py-8 mt-16">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400">
              &copy; 2025 AI Chat Bot. All rights reserved
            </p>
