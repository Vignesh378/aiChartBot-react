    ...
    return <div className="relative">
        ...
        {isOpen && (
            <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50">
                <div className="px-4 pr-3 border-b border-gray-100">
              ...
              <div className="border-t border-gray-100 mt-3 pt-2">
                <a href="#" onClick={onLogout} className="block px-4 py-2 text-sm text-red-600 hover:bg-red-50 transition-colors cursor-pointer">Sign Out</a>
